...
int main() {
    ...
    const std::vector<Case> cases = {
        // Former mask-neighbor fallbacks now have dedicated, tested handlers.
        Case{"ic ivau, x10 (guarded host event)", 0xD50B752Au},
        ...
        // Synthetic encodings independently assembled with GNU AArch64 as.
        Case{"fmadd s0, s1, s2, s3", 0x1F020C20u},
        Case{"fmsub s4, s5, s6, s7", 0x1F069CA4u},
        Case{"fnmadd s8, s9, s10, s11", 0x1F2A2D28u},
        Case{"fnmsub s12, s13, s14, s15", 0x1F2EBDACu},
        Case{"fmadd d0, d1, d2, d3", 0x1F420C20u},
        Case{"fmsub d4, d5, d6, d7", 0x1F469CA4u},
        Case{"fnmadd d8, d9, d10, d11", 0x1F6A2D28u},
        Case{"fnmsub d12, d13, d14, d15", 0x1F6EBDACu},
        Case{"fmadd s31, s31, s31, s31", 0x1F1F7FFFu},
        ...
        Case{"frsqrte v5.4s, v3.4s", 0x6EA1D865u},
        Case{"frecpe v7.4s, v6.4s", 0x4EA1D8C7u},
        ...
        Case{"mul v0.4s, v0.4s, v0.s[1]", 0x4FA08000u},
        Case{"mul v0.4s, v1.4s, v2.s[0]", 0x4F828020u},
        Case{"mla v0.4s, v1.4s, v2.s[0]", 0x6F820020u},
        Case{"mls v0.8h, v1.8h, v2.h[3]", 0x6F724020u},
        Case{"uaddlv h0, v0.8b", 0x2E303800u},
        Case{"saddlv s0, v1.4h", 0x0E703820u},
        Case{"msr nzcv, x4", 0xD51B4204u},
        Case{"mrs x4, nzcv", 0xD53B4204u},
    ...
    const std::vector<Case> must_fall_back = {
        Case{"fmadd h0, h1, h2, h3", 0x1FC20C20u},
        Case{"fp three-source reserved type", 0x1F820C20u},
        Case{"fp three-source reserved bit31", 0x9F020C20u},
        Case{"fp three-source reserved bit29", 0x3F020C20u},
        Case{"fp three-source reserved bit30", 0x5F020C20u},
