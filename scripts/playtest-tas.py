...
def main(argv=None):
    ...
    result = {"rom_name": pathlib.Path(args.rom).name, "states": [], "screenshots": [],
    ...
    result["machine_status"] = (
        ...
        and result["max_jit_transitions"] == 0 and result["rendered_visible_content"]
